use std::{env, net::IpAddr, sync::{Arc, RwLock}, thread, time::{Duration, Instant}};
use anyhow::Result;
use pnet::packet::{icmp::{self, echo_reply::{EchoReplyPacket}, echo_request::{IcmpCodes, MutableEchoRequestPacket}, IcmpCode, IcmpPacket, IcmpType, IcmpTypes}, ip::IpNextHeaderProtocols, util, Packet};
